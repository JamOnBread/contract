...
export const encodeTreasuryDatumAddress: Constr = (
    paymentPubKeyHex: string,
    stakingPubKeyHex?: string
) => {
...
for(const wallet of walletList) {
    tx = tx.payToContract(
        address,
        { inline: Data.to(encodeTreasuryDatumAddress(paymentCredentialOf(await wallet.wallet.address()).hash))},
        {lovelace: 2_000_100n}
    )
}
...
/*
const oldUtxo = Array.from(Array(13).keys()).map(n => {
    // 0c0001261e45b5d1ee357491fa6fd5a12acbc17a81739572c206b8e885485cb8
    return {
        txHash: "077d22dd4e8283b8f360ff9e75609b9e7b4c53c18835c5f6a0740bc43d270bcb",
        outputIndex: 10 + n
    }
})
